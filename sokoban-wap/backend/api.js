...
router.get('/user/:id', oauth.authenticate(), async (req, res) => {
  try {
...
router.post('/user', oauth.authenticate(), async (req, res) => {
  try {
    const usersCollection = req.app.get('usersCollection');
...
router.put('/user/:id', oauth.authenticate(), async (req, res) => {
  try {
    const usersCollection = req.app.get('usersCollection');
...
router.delete('/user/:id', oauth.authenticate(), async (req, res) => {
  try {
    const usersCollection = req.app.get('usersCollection');
